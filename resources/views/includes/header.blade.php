                    ...
                    <ul class="controls-lv">
                        ...
                        <li class="user-log pr-md-4">
                            ...
                            <div class="account-menu">
                                <h4>Membership<span class="usr-status">Pro</span></h4>
                                <div class="sd_menu">
                                    <ul class="mm_menu">
                                        <li>
                                            <span>
                                        ...
                                        <li>
                                            ...
                                            <a href="#" title="">Refferals</a>
                                        </li>
                                        <li>
                                            <span>
                                                <i class=" icon-add_to_playlist"></i>
                                            </span>
                                            <a href="#" title="">Promote Video</a>
                                        </li>
                                        <li>
                                            <span>
                        ...
                        <li>
                            <a href="#" title="" class="btn-default">Promote Video</a>
                        </li>
