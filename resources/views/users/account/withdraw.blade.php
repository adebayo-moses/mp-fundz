    ...
    <div class="container">
        <div class="row col-12 col-lg-10 mx-lg-auto">
            ...
            <div class="sgst_content mt-5">
                ...
                <p>You currently have <span style="font-weight: bold;">{{Auth::user()->coin_balance}}</span> coins and <span style="font-weight: bold;">{{Auth::user()->refferal_revenue}}</span> refferal revenue. Please be aware that you will be able to place withdrawal directly to your bank account the moment you've earned up to <span style="font-weight: bold;">$10</span>. If you've not added your account, kindly <a href="{{route('user.account.add')}}"> Add Your Account</a> now.</p>
            </div>
        </div>
    </div>
